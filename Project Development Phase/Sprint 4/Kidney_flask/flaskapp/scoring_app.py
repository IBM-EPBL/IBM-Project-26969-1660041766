...
API_KEY = "gQ-1zK_tunbdRZanZxtzgj0xGzMneDDs17_w9g2x7-sx"
...
def login():
    ...
    A = [[float(p), float(q), float(r), float(s), float(
        t), float(u1), float(v1), float(x), float(y), float(z)]]
    payload_scoring = {"input_data": [{"fields": [
        ["f0", "f1", "f2", "f3", "f4", "f5", "f6", "f7", "f8", "f9"]], "values":A}]}
